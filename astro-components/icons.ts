...
export const icons = {
  ...
  /** arrow-right (U+F061) — Footer's two CTAs. Figma sets it in FA 7 Pro
   *  *Regular*, which is not reachable: free-regular ships 273 icons and this is
   *  not one of them (nor is `key`). Solid is the closest available weight, and
   *  it is what `key` beside it already uses. Checked 2026-08-03. */
